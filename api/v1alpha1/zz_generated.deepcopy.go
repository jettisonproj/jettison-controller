...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DebugMessageStep) DeepCopyInto(out *DebugMessageStep) {
	*out = *in
	in.BaseStepFields.DeepCopyInto(&out.BaseStepFields)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DebugMessageStep.
func (in *DebugMessageStep) DeepCopy() *DebugMessageStep {
	if in == nil {
		return nil
	}
	out := new(DebugMessageStep)
	in.DeepCopyInto(out)
	return out
}
