...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DockerBuildArtifact) DeepCopyInto(out *DockerBuildArtifact) {
	*out = *in
	if in.Optional != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DockerBuildArtifact.
func (in *DockerBuildArtifact) DeepCopy() *DockerBuildArtifact {
	if in == nil {
		return nil
	}
	out := new(DockerBuildArtifact)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DockerBuildTestPublishStep) DeepCopyInto(out *DockerBuildTestPublishStep) {
	*out = *in
	...
	if in.Artifacts != nil {
		...
		*out = make([]DockerBuildArtifact, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitHubCreatePrStep) DeepCopyInto(out *GitHubCreatePrStep) {
	*out = *in
	in.BaseStepFields.DeepCopyInto(&out.BaseStepFields)
	if in.BaseRef != nil {
		in, out := &in.BaseRef, &out.BaseRef
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitHubCreatePrStep.
func (in *GitHubCreatePrStep) DeepCopy() *GitHubCreatePrStep {
	if in == nil {
		return nil
	}
	out := new(GitHubCreatePrStep)
	in.DeepCopyInto(out)
	return out
}
